...
exports.createPost =async (req,res,next)=>{
    ...
    try{
        ...
        await creator.save()
        io.getIO().emit('posts',{action:'create',post:{...post._doc,creator:{_id:req.userId,name:creator.name}}}) //Sending posts with that object to all connected clients
...
exports.updatePost=async(req,res,next)=>{
    ...
    try{
        ...
        io.getIO().emit('posts',{action:'update',post:newPost})
